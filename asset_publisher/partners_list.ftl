...
<div class="row row-spacing">  
	<#list entries as entry>   
		...
		<#assign nameVal = docXml.valueOf("//dynamic-element[@name='CompanyName']/dynamic-content[@language-id='en_US']/text()") />   
		<#assign shortDescVal = docXml.valueOf("//dynamic-element[@name='Sector']/dynamic-content/text()") />   
        <#assign levelVal = docXml.valueOf("//dynamic-element[@name='Level']/dynamic-content/text()") />   
                        ...
                        <span class="tag"> 
                        	<span class="metadata-entry metadata-tags"> 
                        		<span class="taglib-asset-tags-summary"> 
                        			<a class="badge badge-default badge-sm">${levelVal}</a> 
                        		</span> 
                        	</span> 
                        </span>
					</div>   
