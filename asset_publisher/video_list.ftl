		        ...
		        <div class="card-row">
		      	...
		      	<div class="card-row card-row-padded card-row-valign-top">
		      		<div class="card-col-content">
		       			...
		       			<div class="small lines-3"> ${description} </div>
		       		</div>
		        </div>
		    </div>
		</div>
...
<#macro getVideoPlayer  videoSource assetRenderer >
	<#if videoSource == "Liferay">
		<@liferay_aui.script use="aui-base,aui-video">
	  		new A.Video({
	  			contentBox: '#video-container-${assetRenderer.getClassPK()}',
	  			fixedAttributes: {
	...
	<#if videoSource == "Youtube">
		<iframe width="100%" height="100%" src="${externalSourceVideoURL}"></iframe>
	</#if>
